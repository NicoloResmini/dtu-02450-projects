...
# df = pd.DataFrame(list(zip(range(1, K1 + 1), optimal_ANN, Etest_ANN, opt_lambda, Error_test_rlr, Etest_nofeatures)), columns=columns)
...
print("z = Z_A-Z_B point estimate", z, " CI: ", CI, "p-value", p)
print()
